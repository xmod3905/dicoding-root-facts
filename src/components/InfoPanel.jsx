...
import { createProgressBarStyle, getConfidenceTheme, getConfidenceTextClass } from '../utils/ui';
...
function InfoPanel({ appState, detectionResult, funFactData, error, onCopyFact }) {
  ...
  const renderResultState = () => {
    ...
    const confidenceTextClass = getConfidenceTextClass(confidence);
    ...
    return (
      <div id="state-result" className="result-card result-main">
        ...
        <div className={`confidence-bar ${confidenceTheme}`}>
          ...
          <span id="detected-confidence" className={`confidence-value ${confidenceTextClass}`}>{confidence}%</span>
        </div>
